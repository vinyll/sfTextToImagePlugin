...
/*
  ...
  This is a modified version of Stewart Rosenberger's script intended for
  use with the (as yet unfinsished) jQuery plugin jitr
  by Jamie Thompson - jamazon.co.uk
  
*/

/*
// Theses settings belong to symfony
$font_file  = $_GET['font'] ;
$font_size  = $_GET['size'] ;
$font_color = '#'.$_GET['color'] ;
$background_color = '#'.$_GET['bgcolor'] ;
